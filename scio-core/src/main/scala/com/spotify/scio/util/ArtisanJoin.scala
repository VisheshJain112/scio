...
private[scio] object ArtisanJoin {
  ...
  def left[KEY, A, B](
    ...
    joinImpl(name, a, b)(identity, toOptions)(a.valueCoder, Coder.optionCoder[B, Option](b.valueCoder))
  ...
  def right[KEY, A, B](
    ...
    joinImpl(name, a, b)(toOptions, identity)(Coder.optionCoder[A, Option](a.valueCoder), b.valueCoder)
  ...
  def outer[KEY, A, B](
    ...
    joinImpl(name, a, b)(toOptions, toOptions)(Coder.optionCoder[A, Option](a.valueCoder), Coder.optionCoder[B, Option](b.valueCoder))
